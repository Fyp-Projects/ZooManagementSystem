    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8 col-md-6 mb-4">
          ...
          <p class="text-muted text-small">A zoo management system (ZMS) pertains to the suite of tools, protocols, and procedures used to run and maintain a zoo effectively. This system is crucial not only for ensuring the welfare and health of the animals but also for guaranteeing a positive experience for visitors and ensuring the financial viability of the establishment. </p>
          <p class="text-muted text-small"> Ensures that staff members are knowledgeable about the animals they care for and the protocols of the zoo.Many zoos participate in breeding programs to help endangered species.
Some zoos also support or lead research initiatives and conservation efforts in the wild.</p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <p class="text-muted mb-4 text-small">Mobile + 923081312527 </p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
